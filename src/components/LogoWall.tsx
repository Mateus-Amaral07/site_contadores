...
export default function LogoWall() {
  ...
  return (
    <div ref={revealRef} className="bg-primary py-20 border-y border-white/5 overflow-hidden relative">
      ...
      <section className="relative mx-auto max-w-6xl px-4 md:px-8 z-10 animate-hidden fade-scale">
