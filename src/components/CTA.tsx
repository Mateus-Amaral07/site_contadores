...
export default function CTA() {
  ...
  return (
    <section ref={revealRef} className="bg-primary py-28 lg:py-40 relative overflow-hidden">
      ...
      <div className="mx-auto w-full max-w-screen-md px-4 relative z-10 text-center animate-hidden fade-up">
